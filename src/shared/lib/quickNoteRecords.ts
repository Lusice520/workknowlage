...
import type { QuickNoteMonthEntry, QuickNoteRecord } from '../types/workspace';
...
export function listQuickNoteMonthEntries(monthKey: string): Promise<QuickNoteMonthEntry[]> {
  return getWorkKnowlageApi().quickNotes.listMonth(monthKey);
}
